...
currently_building:
  ...
  - Android apps with OpenCV + C++ NDK

superpower: "I have a PATENTED AI project 🏆"

fun_fact: "My stack spans from SwiftUI to LLMs"
```
...
🔬 **Patent Holder** — AI-based Classroom Behavior Analysis System (India)

📱 **Cross-Platform** — iOS (SwiftUI) + Android (NDK/OpenCV)

🤖 **AI/ML** — Computer Vision, Deep Learning, LLM integrations

🌐 **Full-Stack** — React + Node.js + PostgreSQL + Firebase

📊 **Data Science** — Web scraping, EDA, ML pipelines, Streamlit
...
![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE6?style=for-the-badge&logo=opencv&logoColor=white)
![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)
![SwiftUI](https://img.shields.io/badge/SwiftUI-0063DF?style=for-the-badge&logo=swift&logoColor=white)
...
>
> An advanced **AI-powered vision system** that analyzes real-time student behavior in classrooms — detecting attention levels, engagement patterns, and disruptive behaviors using **YOLO, MediaPipe, OpenCV, and deep learning**.
>
> 🔒 *Repository is private due to active patent proceedings.*
...
### [⚡ ChartSense AI](https://github.com/PurnaJear06/ChartSense-Ai)
AI-powered trading chart analyzer that reads markets like an expert trader.

![Python](https://img.shields.io/badge/-Python-3776AB?style=flat-square&logo=python&logoColor=white)
![TensorFlow](https://img.shields.io/badge/-TensorFlow-FF6F00?style=flat-square&logo=tensorflow&logoColor=white)
![OpenCV](https://img.shields.io/badge/-OpenCV-5C3EE6?style=flat-square&logo=opencv&logoColor=white)

</td>
<td width="50%">

### [📸 Edge Detector App](https://github.com/PurnaJear06/Edge-Detector-App)
Real-time Android edge detection — OpenCV + OpenGL ES 2.0 + C++ NDK.
...
### [📱 Expense iOS](https://github.com/PurnaJear06/Expense-iOS)
Polished iOS finance tracker — SwiftUI + Core Data. ⭐ 1 star.

![SwiftUI](https://img.shields.io/badge/-SwiftUI-FA7343?style=flat-square&logo=swift&logoColor=white)
![Core Data](https://img.shields.io/badge/-Core_Data-147EFB?style=flat-square&logo=apple&logoColor=white)

</td>
<td width="50%">

### [🖥️ Web CAD Viewer](https://github.com/PurnaJear06/Web-based-CAD-viewer)
3D model visualizer in the browser (STL/OBJ) — Wireframe, X-Ray modes.
...
### [🤖 Todo Summary Assistant](https://github.com/PurnaJear06/Todo-Summary-Assistant)
Full-stack task manager + AI summaries → Slack. React + Node + OpenAI.
...
### [🏙️ Real Estate Predictor](https://github.com/PurnaJear06/Project-Real-Estate-Price-Prediction)
ML pipeline: scraping → EDA → model → Streamlit app for Mumbai prices.
